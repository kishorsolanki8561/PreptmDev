-- Full-text style search across content titles.
...
CREATE PROCEDURE [dbo].[Sp_DashboardSearchFilter]
    @SearchText NVARCHAR(500), @StateId INT = NULL, @PageSize INT, @Page INT, @UserId BIGINT = NULL
AS
BEGIN
    SET NOCOUNT ON;
