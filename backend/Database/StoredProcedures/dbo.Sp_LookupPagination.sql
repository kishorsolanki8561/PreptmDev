...
CREATE PROCEDURE [dbo].[Sp_LookupPagination]
    @Page INT, @PageSize INT, @Search NVARCHAR(500) = NULL, @OrderBy NVARCHAR(50) = NULL, @OrderByAsc BIT = 0, @IsActive BIT = NULL, @FromDate DATETIME2 = NULL, @ToDate DATETIME2 = NULL, @LookupTypeId INT = NULL
AS
BEGIN
    SET NOCOUNT ON;
