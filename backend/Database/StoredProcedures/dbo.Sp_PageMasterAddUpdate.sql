...
CREATE PROCEDURE [dbo].[Sp_PageMasterAddUpdate]
    @Id INT = NULL, @Name NVARCHAR(200), @Icon NVARCHAR(100) = NULL, @PageUrl NVARCHAR(500), @MenuId INT, @UserId INT
AS
BEGIN
    SET NOCOUNT ON;
