-- Soft-deletes or toggles active status of a recruitment record.
...
CREATE PROCEDURE [dbo].[Sp_RecruitmentDeleteUpdateStatus]
    @Type NVARCHAR(20), @Id BIGINT, @UserId INT
AS
BEGIN
    SET NOCOUNT ON;
