-- Returns all documents and attachments for a given scheme (for admin edit form).
...
CREATE PROCEDURE [dbo].[Sp_GetSchemeDocumentAndAttachmentLookupDataBySchemeId]
    @SchemeId INT
AS
BEGIN
    SET NOCOUNT ON;
