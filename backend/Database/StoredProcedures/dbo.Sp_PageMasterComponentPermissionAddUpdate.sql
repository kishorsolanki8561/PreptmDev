-- Assigns component-level permissions for a page.
...
CREATE PROCEDURE [dbo].[Sp_PageMasterComponentPermissionAddUpdate]
    @PageId INT, @MenuId INT, @PageComponentId INT, @PageCompActionId INT
AS
BEGIN
    SET NOCOUNT ON;
