-- Returns department detail with associated recruitments.
...
CREATE PROCEDURE [dbo].[Sp_DepartmentDetailsofIdAndSlug]
    @slugUrl NVARCHAR(500) = NULL, @Id INT = NULL, @LanguageCode NVARCHAR(10) = 'en'
AS
BEGIN
    SET NOCOUNT ON;
