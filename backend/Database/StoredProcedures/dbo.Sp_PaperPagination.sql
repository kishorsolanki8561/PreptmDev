-- Admin paginated previous paper list.
...
CREATE PROCEDURE [dbo].[Sp_PaperPagination]
    @Page INT, @PageSize INT, @Search NVARCHAR(500) = NULL, @OrderBy NVARCHAR(50) = NULL, @OrderByAsc BIT = 0, @IsActive BIT = NULL
AS
BEGIN
    SET NOCOUNT ON;
