...
CREATE PROCEDURE [dbo].[Sp_GroupMasterAddUpdate]
    @Id INT = NULL, @Name NVARCHAR(200), @SlugUrl NVARCHAR(200), @UserId INT, @NameHindi NVARCHAR(200) = NULL
AS
BEGIN
    SET NOCOUNT ON;
