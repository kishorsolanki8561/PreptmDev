-- Upserts a job designation master record.
...
CREATE PROCEDURE [dbo].[Sp_JobDesignationMasterAddUpdate]
    @Id INT = NULL, @Name NVARCHAR(300), @UserId INT, @NameHindi NVARCHAR(300) = NULL
AS
BEGIN
    SET NOCOUNT ON;
