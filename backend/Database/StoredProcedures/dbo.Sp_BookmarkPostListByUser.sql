-- Returns paginated list of bookmarked posts for a user.
...
CREATE PROCEDURE [dbo].[Sp_BookmarkPostListByUser]
    @SearchText NVARCHAR(500) = NULL, @StateId INT = NULL, @PageSize INT, @Page INT, @UserId BIGINT, @LanguageCode NVARCHAR(10) = 'en'
AS
BEGIN
    SET NOCOUNT ON;
