-- Returns sub-category dropdown data filtered by category.
...
CREATE PROCEDURE [dbo].[Sp_DDLSubCategoryByCategoryIdAndSlug]
    @CategoryId INT = NULL, @SlugUrl NVARCHAR(200) = NULL
AS
BEGIN
    SET NOCOUNT ON;
