...
CREATE PROCEDURE [dbo].[Sp_BannerMasterPagination]
    @Page INT, @PageSize INT, @Search NVARCHAR(500) = NULL, @OrderBy NVARCHAR(50) = NULL, @OrderByAsc BIT = 0, @IsActive BIT = NULL, @FromDate DATETIME2 = NULL, @ToDate DATETIME2 = NULL, @Title NVARCHAR(300) = NULL, @IsAdvt BIT = NULL
AS
BEGIN
    SET NOCOUNT ON;
