-- Admin paginated block content list.
...
CREATE PROCEDURE [dbo].[Sp_BlockContentsPagination]
    @Page INT, @PageSize INT, @Search NVARCHAR(500) = NULL, @OrderBy NVARCHAR(50) = NULL, @OrderByAsc BIT = 0, @IsActive BIT = NULL, @BlockTypeId INT = NULL, @DepartmentId INT = NULL
AS
BEGIN
    SET NOCOUNT ON;
