-- Upserts a block type master record.
...
CREATE PROCEDURE [dbo].[Sp_BlockTypeAddUpdate]
    @Id INT = NULL, @Name NVARCHAR(200), @SlugUrl NVARCHAR(200), @UserId INT, @NameHindi NVARCHAR(200) = NULL, @Description NVARCHAR(MAX) = NULL, @DescriptionHindi NVARCHAR(MAX) = NULL, @ForRecruitment BIT = 0
AS
BEGIN
    SET NOCOUNT ON;
